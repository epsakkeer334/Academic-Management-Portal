...
const assetPath = window.assetPath || '/admin/assets';
                                ...
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="defaultLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="${assetPath}/img/theme/default.svg" alt="img">
                                        </span>
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="borderedCard">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="${assetPath}/img/theme/bordered.svg" alt="img">
                                        </span>
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="borderlessCard">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="${assetPath}/img/theme/borderless.svg" alt="img">
                                        </span>
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="shadowCard">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="${assetPath}/img/theme/shadow.svg" alt="img">
                                        </span>
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="compactSize">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="${assetPath}/img/theme/compact.svg" alt="img">
                                        </span>
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="hoverviewSize">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="${assetPath}/img/theme/hoverview.svg" alt="img">
                                        </span>
